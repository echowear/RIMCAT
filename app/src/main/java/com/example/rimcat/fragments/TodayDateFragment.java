...
//                dataLogModel == null)
//            return false;
//        dataLogModel.todayDay = Integer.parseInt(inputDay.getText().toString());
//        dataLogModel.todayMonth = Integer.parseInt(inputMonth.getText().toString());
//        dataLogModel.todayYear = Integer.parseInt(inputYear.getText().toString());
        return true;
    }
